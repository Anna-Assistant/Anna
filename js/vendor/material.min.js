...
!(function() {
    ...
    if (e) {
      ...
      e.addEventListener('click', function(s) {
        if ('#' === e.getAttribute('href').charAt(0)) {
          ...
          t.resetTabState_(), t.resetPanelState_(), e.classList.add(
            t.CssClasses_.ACTIVE_CLASS
  ...
  for (
    ...
    (window.requestAnimationFrame = window[
      ...
      ]), (window.requestAnimationFrame = window.requestAnimationFrame), (window.cancelAnimationFrame = window.cancelAnimationFrame);
  }
  if (
  ...
  (window.MaterialMenu = d), (d.prototype.Constant_ = {
    ...
    if (this.element_) {
      ...
      e.classList.add(
        ...
        e,
        this.element_
      ), this.element_.parentElement.removeChild(this.element_), e.appendChild(
        this.element_
      ), (this.container_ = e);
      ...
      for (var a = 0; a < n.length; a++)
        n[a].addEventListener('click', this.boundItemClick_), (n[
          a
        ].tabIndex = '-1'), n[a].addEventListener(
          'keydown',
    ...
    if (this.element_ && this.forElement_) {
      ...
      this.element_.classList.contains(this.CssClasses_.UNALIGNED) ||
        (this.element_.classList.contains(this.CssClasses_.BOTTOM_RIGHT)
          ? ((this.container_.style.right = s.right -
              t.right +
              'px'), (this.container_.style.top = this.forElement_.offsetTop +
              this.forElement_.offsetHeight +
              'px'))
          : this.element_.classList.contains(this.CssClasses_.TOP_LEFT)
              ? ((this.container_.style.left = this.forElement_.offsetLeft +
                  'px'), (this.container_.style.bottom = s.bottom -
                  t.top +
                  'px'))
              : this.element_.classList.contains(this.CssClasses_.TOP_RIGHT)
                  ? ((this.container_.style.right = s.right -
    ...
    if (this.element_ && this.container_ && this.outline_) {
      ...
      (this.container_.style.width = s +
        'px'), (this.container_.style.height = t +
        'px'), (this.outline_.style.width = s +
        'px'), (this.outline_.style.height = t + 'px');
      for (
        var i = this.Constant_.TRANSITION_DURATION_SECONDS *
  ...
  (window.MaterialProgress = h), (h.prototype.Constant_ = {
  ...
  }), (h.prototype.setProgress = h.prototype.setProgress), (h.prototype.setBuffer = function(
    e
  ) {
    (this.bufferbar_.style.width = e + '%'), (this.auxbar_.style.width = 100 -
      e +
      '%');
    ...
    if (this.element_) {
      ...
      (e.className = 'progressbar bar bar1'), this.element_.appendChild(
        ...
        e
      ), (this.auxbar_ = e), (this.progressbar_.style.width = '0%'), (this.bufferbar_.style.width = '100%'), (this.auxbar_.style.width = '0%'), this.element_.classList.add(
        'is-upgraded'
      );
    }
  }), s.register({
  ...
  (window.MaterialSlider = p), (p.prototype.Constant_ = {
    ...
    0 === e
      ...
      ((this.backgroundLower_.style.flex = e), (this.backgroundLower_.style.webkitFlex = e), (this.backgroundUpper_.style.flex = 1 -
        e), (this.backgroundUpper_.style.webkitFlex = 1 - e));
  }), (p.prototype.disable = function() {
    this.element_.disabled = !0;
  }), (p.prototype.disable = p.prototype.disable), (p.prototype.enable = function() {
    this.element_.disabled = !1;
  }), (p.prototype.enable = p.prototype.enable), (p.prototype.change = function(
    e
  ) {
    'undefined' != typeof e &&
  ...
  var C = function(e) {
    ...
    (this.active = !1), (this.actionHandler_ = void 0), (this.message_ = void 0), (this.actionText_ = void 0), (this.queuedNotifications_ = [
    ...
    this.element_.classList.remove(this.cssClasses_.ACTIVE), setTimeout(
      function() {
        this.element_.setAttribute(
          ...
          (this.setActionHidden_(
            !0
          ), (this.actionElement_.textContent = ''), this.actionElement_.removeEventListener(
            'click',
            this.actionHandler_
  ...
  }), (L.prototype.enable = L.prototype.enable), (L.prototype.change = function(
    e
  ) {
  ...
  (window.MaterialTooltip = I), (I.prototype.Constant_ = {
    ...
    this.element_.classList.contains(this.CssClasses_.LEFT) ||
      ...
      ? ((s = t.width / 2), i + a < 0
          ...
          : ((this.element_.style.top = i +
              'px'), (this.element_.style.marginTop = a + 'px')))
      : s + n < 0
          ? ((this.element_.style.left = '0'), (this.element_.style.marginLeft = '0'))
          : ((this.element_.style.left = s +
              'px'), (this.element_.style.marginLeft = n +
              'px')), this.element_.classList.contains(this.CssClasses_.TOP)
      ? (this.element_.style.top = t.top -
      ...
      : this.element_.classList.contains(this.CssClasses_.RIGHT)
          ...
          : this.element_.classList.contains(this.CssClasses_.LEFT)
              ? (this.element_.style.left = t.left -
              ...
              : (this.element_.style.top = t.top +
                  t.height +
                  10 +
                  'px'), this.element_.classList.add(
  ...
  (window.MaterialLayout = f), (f.prototype.Constant_ = {
    ...
    if (e && 'keydown' === e.type) {
      if (
        e.keyCode !== this.Keycodes_.SPACE && e.keyCode !== this.Keycodes_.ENTER
      )
        return;
      e.preventDefault();
    }
    ...
    if (this.element_) {
      ...
      if (
        ...
        d.classList.add(this.CssClasses_.OBFUSCATOR), this.element_.appendChild(
          d
        ), d.addEventListener(
          'click',
          this.drawerToggleHandler_.bind(this)
      ...
      if (
        ...
        ), this.header_.insertBefore(h, this.tabBar_), this.header_.removeChild(
          this.tabBar_
        );
  ...
  (window.MaterialRipple = S), (S.prototype.Constant_ = {
    ...
    if (!this.rippleElement_.style.width && !this.rippleElement_.style.height) {
      ...
      (this.boundHeight = t.height), (this.boundWidth = t.width), (this.rippleSize_ = 2 *
        Math.sqrt(t.width * t.width + t.height * t.height) +
        2), (this.rippleElement_.style.width = this.rippleSize_ +
        'px'), (this.rippleElement_.style.height = this.rippleSize_ + 'px');
    }
    if (
      (this.rippleElement_.classList.add(
        this.CssClasses_.IS_VISIBLE
        ...
        ((this.rippleElement_ = this.element_.querySelector(
          ...
          if (null !== this.rippleElement_) {
            ...
            t
              ...
              : ((i = this.Constant_.FINAL_SCALE), (n = this.rippleSize_ +
                  'px'), e &&
                  (a = 'translate(' +
                    this.boundWidth / 2 +
                    'px, ' +
                    this.boundHeight / 2 +
                    'px)')), (s = 'translate(-50%, -50%) ' +
              a +
